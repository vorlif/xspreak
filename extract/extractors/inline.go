...
func NewInlineTemplateExtractor() extract.Extractor {
	return &inlineTemplateExtractor{}
}

func (i *inlineTemplateExtractor) Run(_ context.Context, extractCtx *extract.Context) ([]extract.Issue, error) {
